...
const GamesContent_5_6 = () => {
  const cards = [
    {
      id: 1,
      title: "Pexeso so zvieratkami",
      image: "/images/card_pexeso_so_zvieratkami.png",
    },
  ...
  return (
    <div
      className="
          ...
          bg-[url('/images/gamepage_5_6_background.png')]
...
export default GamesContent_5_6;
